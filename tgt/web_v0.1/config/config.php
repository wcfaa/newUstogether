...
define('COOKIE_DOMAIN', '.usttogether.com'); // the domain where the cookie is valid for, like '.mydomain.com'
...
*/
 ...
 define("EMAIL_USE_SMTP", false);
 define("EMAIL_SMTP_HOST", 'ns50.hostingspeed.net');
 define("EMAIL_SMTP_AUTH", true);
 define("EMAIL_SMTP_USERNAME", 'noreply@usttogether.com');
 define("EMAIL_SMTP_PASSWORD", 'dtttcct24mg');
 define("EMAIL_SMTP_PORT", 465);
 define("EMAIL_SMTP_ENCRYPTION", 'ssl'); 
...
define("EMAIL_PASSWORDRESET_URL", "www.usttogether.com/web_v0.1/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "noreply@example.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "USTogether");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for USTogether");
...
define("EMAIL_VERIFICATION_URL", "www.usttogether.com/web_v0.1/register.php");
define("EMAIL_VERIFICATION_FROM", "noreply@usttogether.com");
define("EMAIL_VERIFICATION_FROM_NAME", "USTogether");
define("EMAIL_VERIFICATION_SUBJECT", "Account Activation for USTogether");
